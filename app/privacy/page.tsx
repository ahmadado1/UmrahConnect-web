export default function PrivacyPolicy() {
  return (
    <div style={{ maxWidth: "800px", margin: "0 auto", padding: "80px 24px", fontFamily: "system-ui, sans-serif" }}>
      ...
      <p style={{ color: "#444", lineHeight: "1.8", marginBottom: "32px" }}>UmrahConnect is committed to protecting your privacy. This policy explains how we collect, use and protect your information.</p>
      {[
        ...
        { title: "Contact us", content: "If you have questions about this privacy policy, contact us at ahmadado6002@gmail.com" },
      ].map((section) => (
